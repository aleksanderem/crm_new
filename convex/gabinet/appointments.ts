...
async function resolveAutoPackageUsageSupabase(
  ...
  const treatmentCount = args.treatment.treatmentCount as number | undefined;
  ...
  if (!autoPackage) {
    const treatmentName = (args.treatment.name as string | undefined) ?? "Treatment";
    const treatmentPrice = (args.treatment.price as number | undefined) ?? 0;
    const treatmentCurrency = (args.treatment.currency as string | undefined) ?? null;
