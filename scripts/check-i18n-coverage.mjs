...
const KNOWN_MISSING = new Set([
  ...
  // src/components/crm/entity-association-panel.tsx
  "associations.errors.linkFailed",
  // src/components/crm/global-search.tsx
  "search.errors.searchFailed",
  // src/components/csv/csv-export-button.tsx
  "csv.errors.exportFailed",
  // src/components/email/compose-dialog.tsx
  "email.errors.sendFailed",
  // src/components/forms/product-stock-correction-dialog.tsx
  "products.stock.correction.error",
  // src/components/settings/google-integration-card.tsx
  "integrations.errors.disconnectFailed",
  // src/lib/format-action-error.ts — GENERIC_ERROR_MAP entries
  "common.errors.connectionLost",
  "common.errors.saveFailed",

  // --- Gabinet: calendar ---
  // src/components/gabinet/calendar/appointment-dialog.tsx
  "gabinet.appointments.createFailed",
  // src/components/gabinet/calendar/event-dialog.tsx
  "gabinet.events.errors.createFailed",

  // --- Gabinet: deliveries ---
  // src/components/gabinet/deliveries/deliveries-page.tsx
  "gabinet.deliveries.loadError",
  "gabinet.deliveries.analyzeError",
  "gabinet.deliveries.matchError",
  "gabinet.deliveries.postError",
  "gabinet.deliveries.cancelError",
  // src/components/gabinet/deliveries/invoice-import-dialog.tsx
  "gabinet.deliveries.invoiceImport.error",
  // src/components/gabinet/deliveries/item-decisions-dialog.tsx
  "gabinet.deliveries.decisions.saveError",
  "gabinet.deliveries.decisions.postError",

  // --- Gabinet: employees ---
  // src/components/gabinet/employees/account-tab-content.tsx
  "gabinet.employees.errors.changePasswordFailed",
  // src/components/gabinet/employees/employee-permissions-tab.tsx
  "gabinet.employees.permissions.saveError",
  "gabinet.employees.permissions.resetError",
  // src/components/gabinet/employees/sections/personal-info-section.tsx
  "gabinet.employees.errors.photoUploadFailed",
  // src/routes/_app/_auth/dashboard/_layout.gabinet.employees.$employeeId.tsx
  "gabinet.employees.errors.activateFailed",
  "gabinet.employees.errors.blockFailed",
  "gabinet.employees.errors.unblockFailed",
  // src/routes/_app/_auth/dashboard/_layout.gabinet.employees.index.tsx
  "gabinet.employees.errors.deleteFailed",

  // --- Gabinet: packages ---
  // src/routes/_app/_auth/dashboard/_layout.tsx
  "gabinet.packages.errors.createFailed",
  // src/routes/_app/_auth/dashboard/_layout.gabinet.packages.index.tsx
  "gabinet.packages.errors.toggleActiveFailed",
  "gabinet.packages.errors.assignFailed",

  // --- Gabinet: patients ---
  // src/routes/_app/_auth/dashboard/_layout.gabinet.patients.index.tsx
  "gabinet.patients.errors.deleteFailed",

  // --- Gabinet: treatments ---
  // src/routes/_app/_auth/dashboard/_layout.gabinet.treatments.$treatmentId.tsx
  "gabinet.treatments.errors.productsSaveFailed",
  "gabinet.treatments.errors.productsSaveFailedDetail",
  // src/routes/_app/_auth/dashboard/_layout.gabinet.treatments.index.tsx
  "gabinet.treatments.errors.deleteFailed",

  // --- Gabinet: warehouse ---
  // src/components/gabinet/warehouse-inventory-dialog.tsx
  "inventory.confirm.error",

  // --- Admin ---
  // src/routes/_app/_auth/admin.entitlements.tsx
  "admin.entitlements.errors.setFailed",

  // --- CRM: company, contact, lead ---
  // src/routes/_app/_auth/dashboard/_layout.companies.$companyId.tsx
  "companies.errors.updateFailed",
  "leads.errors.createFailed",
  // src/routes/_app/_auth/dashboard/_layout.contacts.$contactId.lazy.tsx
  "contacts.errors.updateFailed",
  "gdpr.exportFailed",
  "gdpr.eraseFailed",
  // src/routes/_app/_auth/dashboard/_layout.leads.$leadId.lazy.tsx
  "leads.errors.updateFailed",

  // --- CRM: activities, calls, invitations ---
  // src/routes/_app/_auth/dashboard/_layout.tsx
  "activities.errors.createFailed",
  "activities.errors.updateFailed",
  "activities.errors.deleteFailed",
  "calls.errors.createFailed",
  "invitations.errors.createFailed",
  ...
  "products.errors.toggleFailed",

  // --- Settings ---
  // src/routes/_app/_auth/dashboard/_layout.settings.activity-types.tsx
  "activityTypes.errors.createFailed",
  "activityTypes.errors.updateFailed",
  // src/routes/_app/_auth/dashboard/_layout.settings.lost-reasons.tsx
  "lostReasons.errors.createFailed",
  "lostReasons.errors.updateFailed",
  // src/routes/_app/_auth/dashboard/_layout.settings.organization.tsx
  "organization.errors.saveFailed",
  // src/routes/_app/_auth/dashboard/_layout.settings.sources.tsx
  "sources.errors.createFailed",
  "sources.errors.updateFailed",
  // src/routes/_app/_auth/dashboard/_layout.gabinet.employees.$employeeId.tsx
  "team.errors.resendFailed",
  "team.errors.cancelFailed",

  // --- Document signing (patient portal) ---
  // src/routes/sign.$token.tsx
  "documents.signing.otpSendError",
  "documents.signing.otpVerifyError",
  "documents.signing.signError",
  // src/routes/sign.form.$token.tsx
  "documents.signing.submitError",
]);
