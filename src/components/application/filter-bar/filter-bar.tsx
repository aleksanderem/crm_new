...
const FilterIconButton = ({ icon: Icon, label, onPress, className }: FilterIconButtonProps) => (
    <AriaButton
        ...
        onPress={onPress}
        className={cx(
            "flex size-9 cursor-pointer items-center justify-center rounded-lg border border-border-primary bg-bg-primary shadow-xs transition duration-100 ease-linear hover:bg-bg-primary_hover",
            className,
        )}
    >
