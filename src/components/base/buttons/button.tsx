...
export const styles = sortCx({
    ...
    colors: {
        ...
        secondary: {
            root: [
                "bg-bg-primary text-fg-secondary shadow-xs-skeuomorphic ring-1 ring-border-primary ring-inset hover:bg-bg-primary_hover hover:text-fg-secondary_hover data-loading:bg-bg-primary_hover",
                // Icon styles
