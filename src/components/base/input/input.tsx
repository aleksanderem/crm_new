    ...
    return (
        <AriaGroup
            ...
            className={({ isFocusWithin, isDisabled, isInvalid }) =>
                cx(
                    "group/input relative flex w-full flex-row place-content-center place-items-center rounded-lg bg-bg-primary shadow-xs ring-1 ring-border-primary transition-shadow duration-100 ease-linear ring-inset",
        ...
        >
            ...
            <AriaInput
                ...
                className={cx(
                    "m-0 w-full bg-transparent text-fg-primary ring-0 outline-hidden placeholder:text-placeholder autofill:rounded-lg autofill:text-fg-primary disabled:cursor-not-allowed",
            ...
            {shortcut && (
                ...
                >
                    <span
                        aria-hidden="true"
                        className="pointer-events-none rounded px-1 py-px text-xs font-medium text-fg-quaternary ring-1 ring-border-secondary select-none ring-inset"
                    >
