...
const Widget = () => {
    ...
    return (
        <Card className="overflow-hidden h-full bg-blue-500 max-w-sm w-full mx-auto py-6 gap-6">
            ...
            <CardContent className="px-6">
                ...
                <div className="bg-card p-5 flex flex-col gap-5 rounded-xl">
                    <div>
                        ...
                        <Progress value={55} className={cn("w-full [&>div]:h-1.5", "**:data-[slot=progress-indicator]:bg-blue-500", "**:data-[slot=progress-track]:bg-blue-500/10")} />
                    </div>
                    <div>
                        <div className="flex justify-between items-baseline mb-3">
                            <div>
                        ...
                        <Progress value={65} className={cn("w-full [&>div]:h-1.5", "**:data-[slot=progress-indicator]:bg-sky-400", "**:data-[slot=progress-track]:bg-sky-400/10")} />
                    </div>
                </div>
            </CardContent>
        </Card>
