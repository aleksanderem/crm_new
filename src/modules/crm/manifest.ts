...
export const crmManifest: ModuleManifest = {
  ...
  settingsNav: [
    { sectionKey: "settings.crmSection", labelKey: "settingsNav.pipelines", to: "/dashboard/settings/pipelines", adminOnly: true },
    ...
    { sectionKey: "settings.communicationSection", labelKey: "settingsNav.mail", to: "/dashboard/settings/mail", adminOnly: true },
    ...
    { sectionKey: "settings.documentsSection", labelKey: "settingsNav.documentTemplates", to: "/dashboard/settings/form-templates", adminOnly: true },
    { labelKey: "settingsNav.documentComponents", to: "/dashboard/settings/document-components", adminOnly: true },
    { sectionKey: "settings.accountSection", labelKey: "settingsNav.profile", to: "/dashboard/settings/profile" },
  ...
  pageContexts: [
    ...
    },
    {
      ...
      actions: [
        ...
        { labelKey: "nav.actions.importCsvProducts", icon: Upload, dispatch: "importCsv" },
        { labelKey: "nav.actions.exportCsvProducts", icon: Download, dispatch: "exportCsv" },
