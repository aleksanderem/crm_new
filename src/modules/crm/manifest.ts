...
export const crmManifest: ModuleManifest = {
  ...
  settingsNav: [
    ...
    { labelKey: "settingsNav.customFields", to: "/dashboard/settings/custom-fields" },
    { labelKey: "settingsNav.activityTypes", to: "/dashboard/settings/activity-types" },
    ...
    { labelKey: "settingsNav.mail", to: "/dashboard/settings/mail" },
    { labelKey: "settingsNav.automations", to: "/dashboard/settings/automations" },
    { labelKey: "settingsNav.emailTemplates", to: "/dashboard/settings/email-templates" },
    { labelKey: "settingsNav.emailEvents", to: "/dashboard/settings/email-events" },
