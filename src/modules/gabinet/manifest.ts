  ...
  settingsNav: [
    {
      ...
      sectionKey: "settings.gabinetSection",
    },
  ...
  pageContexts: [
    ...
    },
    {
      ...
      actions: [
        ...
        { labelKey: "nav.actions.manageSchedules", icon: Calendar, dispatch: "manageSchedules" },
        { labelKey: "nav.actions.viewLeaves", icon: CalendarCheck, dispatch: "viewLeaves" },
