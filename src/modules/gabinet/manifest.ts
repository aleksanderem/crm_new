  ...
  settingsNav: [
    {
      ...
      permissionFeature: "gabinet_settings",
    },
    ...
    { labelKey: "gabinet.locations.title", to: "/dashboard/gabinet/settings/locations", permissionFeature: "gabinet_settings" },
    { labelKey: "gabinet.equipment.title", to: "/dashboard/gabinet/settings/equipment", permissionFeature: "gabinet_settings" },
    { labelKey: "gabinet.roles.title", to: "/dashboard/gabinet/settings/roles", permissionFeature: "gabinet_settings" },
  ],
  pageContexts: [
    {
      key: "dashboard",
